...
public class TransactionsTask {
    public static void main(String[] args) {
        ...
        System.out.println(transaction1.getAccount().getNumber());
        // 1. собрать Map<String, Long>, где String - номер (number) аккаунта, Long - сумма транзакций (sum) по аккаунту
        /*public static <T, K, U > Collector < T, ?,Map<K, U>>toMap(Function < ? super T, ? extends K > keyMapper,
                Function < ? super T, ? extends U > valueMapper,
                BinaryOperator < U > mergeFunction)*/
        Map<String, Long> sumOfAccount = transactionStream
        ...
        // 2. найти общую сумму транзакций по по всем аккаунтам
        transactionStream = Stream.of(transaction1, transaction2, transaction3,
                transaction4, transaction5, transaction6, transaction7);
        System.out.println(transactionStream.collect(Collectors.summingLong(transaction -> transaction.getSum())));
    }
}