...
// можно обращаться без имени класса
// статический импорт статического метода lastDayOfMounth из класса TemporalAdjusters
// позволит вызывать метод без обращения к классу
...
public class DateTimeExample {
    public static void getLocalDateTimeDescription(){
        ...
        // С помощью методов можно получить любую инфу из LocalTime/LocalDate/LocalDateTime
        System.out.println(LocalDateTime.now().getDayOfWeek());
        System.out.println(LocalDateTime.now().plus(45, ChronoUnit.CENTURIES));
        // System.out.println(LocalDateTime.now().plus(Period.ofWeeks(5)); Используются реже
        System.out.println(LocalDateTime.now().minus(45, ChronoUnit.DAYS));
        // System.out.println(LocalDateTime.now().minus(Duration.ofDays(4)); Используются реже

        System.out.println(MonthDay.from(LocalDateTime.now()));
        System.out.println(DayOfWeek.from(LocalDateTime.now()));

        // метод принимает TemporalAdjusters adjuster
        ...
        // статический импорт позволит вызывать метод без обращения к классу, те вместо
