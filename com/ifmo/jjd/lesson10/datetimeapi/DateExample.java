...
public class DateExample {
    ...
    public static void getLocalDateDescription() {
        ...
        // можно использовать отрицательные аргументы. Вести будут себя соответственно
        ...
        // ChronoUnit:
        // позволяет обратиться и к дате и ко времени. Высчитывает всю дату целиком
        ...
        // Period:
        // сравнивает только то, на что указывает метод (.getMounth вернет только разницу между месяцами вне зависисости от года)
